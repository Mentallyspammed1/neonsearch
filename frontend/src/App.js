  ...
  return (
    ...
    >
      <div className="relative aspect-video bg-gray-900">
        ...
        {video.duration && (
          <div className="absolute bottom-2 right-2 px-2 py-1 bg-black bg-opacity-80 text-white text-xs rounded font-medium">
            {video.duration}
          </div>
        )}
      ...
      <div className="p-4">
        <h3 
          className="font-semibold text-white text-sm line-clamp-2 group-hover:text-purple-400 transition-colors mb-2 min-h-[2.5rem]"
          title={video.title}
        >
          {video.title}
        </h3>
